...
public class Keybind extends Component {
    ...
    public void renderComponent() {
        ...
        FontManager.F18.drawStringWithShadow(binding ? "Press a key..." : ("Key: " + Keyboard.getKeyName(this.parent.mod.getKeyCode())), (parent.parent.getX() + 7) , (parent.parent.getY() + offset + 2)  + 1, -1);
        GL11.glPopMatrix();
    }
