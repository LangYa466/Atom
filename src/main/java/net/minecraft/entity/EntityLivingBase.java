...
public abstract class EntityLivingBase extends Entity
{
    ...
    protected void jump()
    {
        ...
        if(this == Minecraft.getMinecraft().thePlayer && Client.getInstance().getEventManager() != null) {
            EventJump eventJump = new EventJump(angle);
    ...
    public void onUpdate()
    {
        ...
        if (Client.getInstance().getEventManager() != null && mc.theWorld != null && mc.thePlayer != null) {
